...
urlpatterns = [
    ...
    url(r'^katana/wdf/', include('apps.wdf_edit.urls')),
    url(r'^katana/projects/', include('apps.projects.urls')),
    url(r'^katana/suites/', include('apps.suites.urls')),
    url(r'^katana/cases/', include('apps.cases.urls')),
    url(r'^katana/execution/', include('apps.execution.urls')),
]
