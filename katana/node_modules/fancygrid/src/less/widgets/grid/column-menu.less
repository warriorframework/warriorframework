...
.fancy-grid-header-cell-trigger-image {
  ...
  margin-top: 8px;
  margin-left: 5px;
  background: url(images/default/sort-arrows.png) no-repeat scroll 0 1px transparent;
}
...
.fancy-grid-header-cell-trigger-up {
  background: url(images/default/sort.png) no-repeat scroll 0 1px transparent;
...
.fancy-menu-item-active .fancy-grid-header-cell-trigger-down {
  background-image: url(images/default/sort-over.png);
}
