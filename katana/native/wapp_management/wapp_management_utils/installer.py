...
class Installer:
    ...
    def __init__(self, base_directory, path_to_app):
        ...
        self.app_directory = join_path(self.base_directory, "katana", "installed_apps")
        ...
        self.app_name = get_sub_folders(join_path(path_to_app, "warriorframework", "katana", "installed_apps"))[0]
        self.path_to_app = join_path(path_to_app, "warriorframework", "katana", "installed_apps", self.app_name)
        ...
        self.pkg_in_settings = "installed_apps.{0}".format(self.app_name)
